...
class ModelMutatorGenerator {
  ...
  private function getName(): string {
    ...
    $remove_schema =
      Str::endsWith($name, 'Schema') ? Str::substr($name, 0, -6) : $name;
  ...
  private function getCreateMethod(): CodegenMethod {
    ...
    return
      codegen_method('create')
        ->setReturnType('this')
        ->setBody(
          hack_builder()->addReturn('new %s()', $this->getName())->getCode(),
        );
  }
  ...
  private function getSaveMethod(): CodegenMethod {
    ...
    return
      codegen_method('save')->setReturnType('int')->setBody($body->getCode());
  }
  ...
  private function getCheckRequiredFieldsMethod(): CodegenMethod {
    ...
    return
      codegen_method('checkRequiredFields')
        ->setReturnType('void')
